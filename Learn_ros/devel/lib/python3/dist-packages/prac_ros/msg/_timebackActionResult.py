...
"""autogenerated by genpy from prac_ros/timebackActionResult.msg. Do not edit."""
import codecs
import sys
...
class timebackActionResult(genpy.Message):
  _md5sum = "f5313066596d09fa068b33e76073d44a"
  _type = "prac_ros/timebackActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','prac_ros/timebackResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(timebackActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = prac_ros.msg.timebackResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = prac_ros.msg.timebackResult()
