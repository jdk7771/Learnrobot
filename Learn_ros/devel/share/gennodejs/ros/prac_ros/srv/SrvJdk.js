...
class SrvJdkRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SrvJdkRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SrvJdkRequest
    let len;
    let data = new SrvJdkRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SrvJdkRequest(null);
...
class SrvJdkResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SrvJdkResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SrvJdkResponse
    let len;
    let data = new SrvJdkResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SrvJdkResponse(null);
...
module.exports = {
  Request: SrvJdkRequest,
  Response: SrvJdkResponse,
  md5sum() { return '58903d21a3264f3408d79ba79e9f7c7e'; },
  datatype() { return 'prac_ros/SrvJdk'; }
};
